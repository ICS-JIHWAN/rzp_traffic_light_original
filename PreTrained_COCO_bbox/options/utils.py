...
class Config:
    def __init__(self):
        ...
        self.parser.add_argument('--coco_dir_path', type=str, default='/storage/jhchoi/coco', help='COCO directory path')
        self.parser.add_argument('--continue_FPN_train', type=bool, default=False, help='Whether initialize or load the model')
        self.parser.add_argument('--continue_REG_train', type=bool, default=False, help='Whether initialize or load the model')

        self.parser.add_argument('--check_point_path', type=str, default='/home/jhchoi/PycharmProjects/traffic_lights/Model/Check_point', help='Check point directory path')
        self.parser.add_argument('--fpn_check_point_file_name', type=str, default='fpn_resnet18_0.93347197355001.pth', help='FPN check point file name')
        self.parser.add_argument('--regression_check_point_file_name', type=str, default='regression_resnet18_0.93347197355001.pth', help='Regression check point file name')

        self.parser.add_argument('--input_size', type=list, default=[416, 416], help='Width and Height of input image')
        self.parser.add_argument('--num_classes', type=int, default=80, help='number of classes')

        self.parser.add_argument('--backbone_network', type=str, default='resnet18', help='Name of the backbone network')
        self.parser.add_argument('--epochs', type=int, default=100, help='Number of epochs')
        self.parser.add_argument('--batch_size', type=int, default=32, help='Number of batch')
